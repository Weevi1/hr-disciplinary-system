...
// Local helpers + sub-components (extracted Phase 2 Tier 3D step 4)
import {
  getSeverityColor,
  getSeverityIcon,
  formatEscalationPath,
} from './categoryHelpers';
import { CategoryTemplateSelectorModal } from './CategoryTemplateSelectorModal';
