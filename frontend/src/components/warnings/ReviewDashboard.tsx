...
// Pure helpers + archive sub-view (extracted Phase 2 Tier 3D step 3)
import {
  safeRenderText,
  convertFirestoreTimestampToDate,
  isWithinAppealPeriod,
} from './reviewDashboardHelpers';
import { ReviewDashboardArchiveView } from './ReviewDashboardArchiveView';
...
export const WarningsReviewDashboard: React.FC<WarningsReviewProps> = ({
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      {viewMode === 'archive' ? (
        <ReviewDashboardArchiveView
          archivedWarnings={archivedWarnings}
          onBackToActive={() => setViewMode('warnings')}
