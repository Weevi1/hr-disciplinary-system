 ...
 */
async function deleteAudioFromStorage(expiredFile) {
    try {
 ...
 */
async function updateWarningAfterDeletion(warningId, organizationId, expiredFile, organizationName) {
    try {
 ...
 */
async function logGlobalCleanupAudit(result) {
    try {
